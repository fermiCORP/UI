...
<header>
    <div class="nav container">
        ...
        <div class="menu">
            <img src="Documentazione/styles/img/menu.png" alt="">
            <div class="navbar">
...
<section class="home container" id="home">
    <img id="mainImage" src="Documentazione/styles/img/home.png" alt="Main Image">
    <div class="home-text">
        <h1>LA CITTÀ DEL <br> FUTURO</h1>
        <a href="./php/dettagli.php?gameId=41494" class="btn">Scopri Di Più</a>
    </div>
</section>
